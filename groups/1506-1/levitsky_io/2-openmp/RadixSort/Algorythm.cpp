...
//}
//
//void Algorythm::welcomeWords(int * size)
//{
...
//}
//
//void Algorythm::initData(BinaryInt ** dataArray, int * size, int * mas)
//{
...
//}
//
//void Algorythm::copyData(BinaryInt ** src, BinaryInt ** dest, int * size)
//{
...
//}
//
//void Algorythm::printArray(BinaryInt ** array, int * size)
//{
...
//}
//
//void Algorythm::outputMessage(double * time1, double * time2, bool isRight)
//{
...
//}
//
//void Algorythm::RadixSort(queue<BinaryInt>* data, queue<BinaryInt>* sortedData, int * numOfByte, int * numOfBitInByte)
//{
...
//}
//
//BinaryInt * Algorythm::merge(BinaryInt ** firstArray, BinaryInt ** secondArray, int * sizeFirst, int * sizeSecond)
//{
...
//}
//
//void Algorythm::setResult(queue<BinaryInt>* sortedData, BinaryInt ** data)
//{
...
//}
//
//bool Algorythm::checkResult(BinaryInt ** nonParallel, BinaryInt ** parallel, int * size)
//{
//	for (int i = 0; i < *size; i++)
//	{
...
//}
//
//int Algorythm::Start(int size, int * mas, int *& sortedmas)
//{
//	cout.precision(15);
//	//int size;
